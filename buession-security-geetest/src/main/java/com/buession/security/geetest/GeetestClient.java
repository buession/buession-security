...
public class GeetestClient {
    ...
    public Status enhencedValidateRequest(String challenge, String validate, String seccode, RequestData requestData){
        ...
        Response response;
        try{
            response = httpClient.post(URLBuilder.buildValidateUrl(), formData);
            ...
            Map<String, Object> returnMap = objectMapper.readValue(response.getBody(), new TypeReference<Map<String,
                    Object>>() {
    ...
    protected Status registerChallenge(RequestData requestData){
        ...
        try{
            ...
            ProcessResult processResult = objectMapper.readValue(response.getBody(), new TypeReference<ProcessResult>
                    () {
